		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
							...
							<div class="panel panel-primary ">
								<div class="panel-heading">	<center>All Item List</center></div>
				...
				<table style="color:black; class="table" id="manageProductTable">
					<thead>
						<tr>
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
				...
				<div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Cost: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	        ...
	        <div class="form-group">
			 ...
			 <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Supplier: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
